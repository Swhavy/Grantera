...
const steps = [
  ...
  },
  {
    ...
    description: "Share your detailed business proposal (PDF format) outlining your plans, goals, and expected impact.",
  },
  {
    icon: Search,
  ...
  },
  {
    ...
    description: "Successful applicants receive their grant funding and join our community of empowered entrepreneurs.",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Getting your business grant is simple. Follow these four steps to start your journey with Grantera.
          </p>
        </div>
