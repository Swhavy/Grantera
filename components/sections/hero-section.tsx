      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-8 md:mb-12 text-white/90 leading-relaxed max-w-3xl mx-auto text-pretty">
            Grantera empowers ambitious Nigerian entrepreneurs with business grants to turn their vision into reality.
            No loans. No equity. Just pure opportunity.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="bg-[#FFB800] text-[#003366] hover:bg-[#FFB800]/90 font-semibold text-base md:text-lg px-8 py-6"
            >
              <Link href="#apply">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="bg-white/10 text-white border-white/30 hover:bg-white/20 text-base md:text-lg px-8 py-6"
            >
